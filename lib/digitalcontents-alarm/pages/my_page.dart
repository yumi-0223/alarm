  ...
  void _checkAlarmTime() {
    for (var todo in todoList) {
      if (todo.alarmTime != null && todo.isAlarmOn) {
        ...
        if (now.hour == todo.alarmTime!.hour && now.minute == todo.alarmTime!.minute) {
          // アラーム時刻と一致した場合に画面遷移
          Navigator.push(
            context,
      ...
      children: [
        ...
        if (todo.alarmTime != null)
          Text(
            ...
            style: TextStyle(fontSize: 20, color: const Color.fromARGB(255, 70, 70, 70)),
          ),
        ...
        // カメラボタンやメッセージ表示部分
        Padding(
          padding: EdgeInsets.only(bottom: MediaQuery.of(context).size.height * 0.3), // グループタブとの間隔調整
          child: Column(
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
