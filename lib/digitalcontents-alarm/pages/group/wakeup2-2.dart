...
import '../group/alarm_group2.dart'; // 対象ページのインポートを追加

class Wakeup2_2 extends StatelessWidget {
  final String userId;

  const Wakeup2_2({required this.userId});
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => AlarmGroup2(), // ページに遷移
                      ),
                    );
                  },
